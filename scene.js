...
(function () {
  ...
  function corridor() {
    ...
    var twGaugeFrac = 0.92; // how much of the deck's width the two rails span — pushed near the deck edges so the cross-ties read as running between the rails, not floating inside them
